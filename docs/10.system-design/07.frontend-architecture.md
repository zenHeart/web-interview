...
## 面对超万行严重腐化的前端遗留系统，如何用绞杀者模式进行渐进式重构？ {#p0-legacy-refactor-strangler}
...
## 大型前端 Monorepo 项目中，如何进行依赖治理与增量构建缓存加速？ {#p0-monorepo-governance-turborepo}
...
## 如何设计一套跨 Web、小程序和桌面端的多端统一 SDK 架构？ {#p0-cross-platform-sdk-architecture}
...
## 前端如何搭建全链路性能监控体系？核心指标（LCP、INP、CLS）如何采集与告警？ {#p0-performance-monitoring-cwv}
...
## 微前端技术方案该如何选型？iframe、qiankun、wujie 与模块联邦有什么优缺点？ {#p0-micro-frontend-architecture-evolution}
...
## 前端如何实现离线可用与弱网重试？多人协作下的数据冲突如何消解？ {#p0-offline-first-crdt-sync}
