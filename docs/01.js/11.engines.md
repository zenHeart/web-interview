...
4. 显式触发：如 global.gc()（需启动 Node 参数），或者在调试页面内存面板点击清理。最终会调用 [Heap::CollectAllGarbage](https://github.com/v8/v8/blob/2243f90dedd71bcc1e998817db335f5c5a08903d/src/heap/heap.cc#L1282)
