...
| 分类 | 命令 | 作用 |
|------|------|------|
| 版本管理 | `git init`, `git clone` | 初始化或克隆仓库 |
| 暂存提交 | `git add`, `git commit` | 添加到暂存区、提交更改 |
| 分支操作 | `git branch`, `git checkout`, `git merge` | 创建分支、切换分支、合并分支 |
| 远程同步 | `git push`, `git pull`, `git fetch` | 推送、拉取、获取远程变更 |
| 状态查看 | `git status`, `git log`, `git diff` | 查看状态、历史、差异 |
| 撤销回滚 | `git reset`, `git revert`, `git checkout` | 重置、还原、恢复文件 |

**延伸阅读**

- [Git 官方文档](https://git-scm.com/docs) - 完整命令参考
- [Pro Git 书籍](https://git-scm.com/book/zh/v2) - Git 深入学习
...
- [Git Stash 完整指南](https://www.atlassian.com/git/tutorials/saving-changes/git-stash)
...
- [二分查找错误](https://www.atlassian.com/git/tutorials/undoing-changes/git-bisect)
...
- [Git 远程分支管理](https://git-scm.com/book/zh/v2/Git-分支-远程分支)

</Answer>

## git 仓库迁移应该怎么操作？{#p2-git-migration}
...
- [Git Bundle 教程](https://git-scm.com/book/zh/v2/Git-工具-打包)
- [仓库迁移最佳实践](https://docs.github.com/en/repositories/creating-and-managing-repositories/duplicating-a-repository)
...
- [Git 分支管理策略](https://git-scm.com/book/zh/v2/Git-分支-分支开发工作流)
