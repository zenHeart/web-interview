...
* [component elements](https://legacy.reactjs.org/blog/2015/12/18/react-components-elements-and-instances.html)

</Answer>

## 什么是 ReactNode 它和 Element 的区别是什么？ {#p0-react-node-vs-element}

<Answer>

参看 [ReactNode](https://github.com/facebook/react/blob/main/packages/shared/ReactTypes.js#L11) 定义 ReactNode 可以理解为 React 中可以实际渲染的所有类型的节点，包括 ReactElement、Portal、文本节点、Fragment、Provider 和 Consumer 等。
...
而 ReactElement 是 ReactNode 的一个子集，表示一个具体的 React 元素。也就是我们常说的 Virtual DOM(VDOM)，它是一个不可变的对象，描述了 UI 的结构和属性。结构参考 [React$Element](https://github.com/facebook/react/blob/97cdd5d3c33eda77be4f96a43f72d6916d3badbb/scripts/flow/environment.js#L91)
...
## state 和 props 区别是什么 {#p1-state-props}
...
* [React 官方文档：Props 传递](https://react.dev/learn/passing-props-to-a-component)
* [React 单向数据流](https://react.dev/learn/thinking-in-react#step-2-build-a-static-version-in-react)
* [react basic](https://github.com/reactjs/react-basic) react 的一些核心理念

</Answer>

## 什么是 Context 如何使用? {#p0-react-context}
...
* [Why Do React Hooks Rely on Call Order?](https://overreacted.io/why-do-hooks-rely-on-call-order/) 解释为什么 Hooks 依赖调用顺序
